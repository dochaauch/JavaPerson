...
public class homework221110 {
    ...
    public static class UserValidationService {
        public boolean isCorrectUsers(User users) {
            return areAllFieldsNotEmpty(users) && hasEmailAtSign(users) &&
        ...
        boolean hasEmailAtSign(User users) {
            return users.allFields().get("email").toString().contains("@");
        }
    ...
    static class Main {
        public static void main(String[] args) {
            ...
            System.out.println(Arrays.toString(incorrectUsers));
