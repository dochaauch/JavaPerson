package profJava.lesson230208.deadlock;
    ...
    public void run() {
        ...
        synchronized (DeadLock.LOCK_1) {
            ...
            synchronized (DeadLock.LOCK_2) {
                System.out.println("****:T1: Monitor LOCK_2 and LOCK_1 were caught****");
            }
        }
    }
}
...
class T2 extends Thread {
    ...
    public void run() {
        ...
        synchronized (DeadLock.LOCK_2) {
            ...
            synchronized (DeadLock.LOCK_1) {
                System.out.println("****T2: Monitor LOCK_2 and LOCK_1 were caught****");
            }
        }
    }
}