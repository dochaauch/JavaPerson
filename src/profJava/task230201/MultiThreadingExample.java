...
//            computeValue(index + offset, arr[index]);
//        }
//    }
//
...
//            thread2.join();
//            thread1.join();
//        } catch (InterruptedException e) {  //исключения всего, что тормозит потоки
